...
export default function IplBillsPage() {
  ...
  const fetchBills = async () => {
    ...
    try {
      ...
      showError('Gagal memuat data tagihan IPL');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <PageContainer title={`Tagihan IPL - ${orgLabel}`} description="">
      <Box mt={3}>
        <Card>
          <CardContent>
              ...
              <Table>
                ...
                <TableBody>
                  {isLoading ? (
                    ...
                    <TableRow>
                      <TableCell colSpan={5} align="center">Belum ada data tagihan IPL</TableCell>
                    </TableRow>
                  ) : (
                    bills.map((bill) => (
